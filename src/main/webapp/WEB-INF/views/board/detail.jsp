                    ...
                    <div class="d-flex align-items-end pb-4 border-bottom border-2 text-muted px-0">
                        <div class="d-flex align-items-baseline" style="gap: 80px;">
                            <div class="info-item">
                                ...
                                <span class="fw-bold text-dark" style="font-size: 2.2rem; line-height: 1.1;">{{store.vo.id}}</span>
                            </div>

                            <div class="info-item">
                                <small class="text-uppercase fw-bold d-block" style="letter-spacing: 1px; font-size: 1.1rem; margin-bottom: 2px;">지역</small>
                                <span class="fw-medium text-dark" style="font-size: 2.2rem; line-height: 1.1;">{{store.vo.region || '미정'}}</span>
                            </div>

                            <div class="info-item">
                                <small class="text-uppercase fw-bold d-block" style="letter-spacing: 1px; font-size: 1.1rem; margin-bottom: 2px;">카테고리</small>
                                <span class="fw-medium text-dark" style="font-size: 2.2rem; line-height: 1.1;">{{store.vo.category || '일반'}}</span>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <span class="fw-medium text-dark" style="font-size: 2.2rem; line-height: 1.1;">
                                    {{ store.vo.time ? store.vo.time.split('T')[0] : '' }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="ms-auto text-end">
                            ...
                            <span class="fw-black text-dark" style="font-size: 2.2rem; line-height: 1.1;">{{store.vo.hit}}</span>
                        </div>
                    </div>
                </div>
