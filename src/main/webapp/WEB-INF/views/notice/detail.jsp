...
<section class="breadcrumb-section py-5" id="notice_detail" style="background: transparent;">
    <div class="container" style="max-width: 1500px;">
        <div class="row">
            <div class="col-lg-12 text-left px-0"> <div class="breadcrumb__text">
                    ...
                    <div class="breadcrumb__option" style="font-size: 1.2rem; color: #888;">
                        <span><a href="/notice/list" class="text-decoration-none text-muted">공지사항</a> &nbsp; > &nbsp; {{store.vo.not_title}}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content-wrapper mt-5">
            <div class="info-bar-section mb-5">
                <div class="d-flex align-items-end pb-3 border-bottom border-2 text-muted px-0">
                    <div class="d-flex gap-5 align-items-baseline">
                        <div class="info-item">
                            <small class="text-uppercase fw-bold d-block" style="letter-spacing: 1px; font-size: 0.85rem; margin-bottom: -4px;">번호.</small>
                            <span class="fw-bold text-dark" style="font-size: 2.2rem; line-height: 1.1;">{{store.vo.not_id}}</span>
                        </div>
                        <div class="vr opacity-25" style="height: 40px; align-self: center;"></div>
                        <div class="info-item">
                            <small class="text-uppercase fw-bold d-block" style="letter-spacing: 1px; font-size: 0.85rem; margin-bottom: -4px;">작성자</small>
                            <span class="fw-medium text-dark" style="font-size: 2.2rem; line-height: 1.1;">{{store.vo.mem_id}}</span>
                        </div>
                        <div class="vr opacity-25" style="height: 40px; align-self: center;"></div>
                        <div class="info-item">
                            <small class="text-uppercase fw-bold d-block" style="letter-spacing: 1px; font-size: 0.85rem; margin-bottom: -4px;">작성일</small>
                            <span class="fw-medium text-dark" style="font-size: 2.2rem; line-height: 1.1;">{{store.vo.not_date}}</span>
                        </div>
                    </div>

                    <div class="ms-auto text-end">
                        <small class="text-uppercase fw-bold d-block text-secondary" style="letter-spacing: 1px; font-size: 0.85rem; margin-bottom: -4px;">조회ㅅ</small>
                        <span class="fw-black text-dark" style="font-size: 3rem; line-height: 1.1;">{{store.vo.view_cnt}}</span>
                    </div>
                </div>
            </div>

            <div class="article-body mb-0" style="min-height: 300px;">
                <div style="font-size: 1.85rem; line-height: 2.1; white-space: pre-wrap; color: #1a1a1a; letter-spacing: -0.01em;">
