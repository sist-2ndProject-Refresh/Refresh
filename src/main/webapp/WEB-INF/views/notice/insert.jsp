				...
				<tbody>
					<tr>
						...
						<td colspan="3" class="text-left"><input type="text"
							v-model="store.not_title" class="form-input"
					...
					<tr>
						...
						<td colspan="3" class="text-left"><textarea rows="12"
								v-model="store.not_content" class="form-textarea"
					...
					<tr>
						<td colspan="4" class="text-center"
							...
							<button @click="store.noticeInsert()"
								class="btn btn-success btn-action me-2">글 등록하기</button>
							<button @click="history.back()"
								class="btn btn-secondary btn-action">취소</button>
						</td>
					</tr>
				</tbody>
			</table>
