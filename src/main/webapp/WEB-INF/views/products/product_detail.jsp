    ...
    <div class="row">
                ...
                <tr>
                	<td colspan="2" class="text-right fs-4">
                		...
                		<c:if test="${vo.user_no != sessionScope.no}">
	                		...
	                		<a href="/faq?subject=${svo.stvo.storename }" style="opacity: 0.7; margin-left: 10px;">신고하기</a>
	                	</c:if>	
                	</td>
                </tr>
                <tr>
        ...
        <div class="container">
        	<div class="d-flex justify-content-end align-items-center gap-2">
				...
				<a href="/product/list"><input type="button" class="btn-st fw-bold fs-1" style="background-color: #E0E0E0; color: #333;" value="목록"></a>
	        </div>
        </div>  
