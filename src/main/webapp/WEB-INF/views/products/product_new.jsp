		...
		<div class="row">
			...
			<div>
				...
				<div class="mar-top-50 d-flex  gap-100">
					...
					<textarea class="form-control fs-2" v-model="store.description" rows="10" cols="100" maxlength="4000" style="resize: none;" placeholder="상품에 대한 설명을 최대한 자세히 적어주세요" ></textarea>
				</div>
			</div>
			<div>
				<hr class="hr-st" style="width: 100%; margin-top: 50px;">
