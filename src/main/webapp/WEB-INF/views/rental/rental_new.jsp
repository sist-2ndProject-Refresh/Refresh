...
<body>
	<div class="container" id="rental_insert">
		<div class="row">
			<h2>대여물품 등록</h2>
			<div>
			...
			<div>
				<hr class="hr-st" style="width: 100%; margin-top: 50px;">
				<div class="mar-top-50 d-flex align-items-center gap-100">
					<span class="fs-2 fw-normal" style="min-width:100px;">대여 기간</span>
					<div class="d-flex align-items-center gap-2">	
						<input class="form-control fs-2 text-right" v-model="store.days" type="number" min="1" style="width: 200px; height: 40px;" placeholder="기간을 작성해주세요(예: '1'일)" >
						<span class="fs-2">일</span>
					</div>
				</div>
			</div>
			<div>
					...
					<div>
						...
						<div v-if="store.includeDelivery === 1">
							...
							<div class="d-flex align-items-center gap-2" style="margin-top: 20px;">	
								...
								<input class="form-control fs-2 text-right" v-model="store.normalPrice" type="number" min="1" style="width: 200px; height: 40px;" placeholder="금액을 작성해주세요" >
								<span class="fs-2">원</span>
							</div>
			...
			<div>
				...
				<div class="mar-top-50 d-flex align-items-stretch gap-100">
					...
					<div style="margin-bottom:50px" ref="addressRef" v-if="store.isDirect">	
						...
						<input class="form-control fs-2" type="text" v-model="store.address2" style="width: 300px; height: 40px; margin-top: 10px;" placeholder="거래 상세 위치를 작성해주세요">
					</div>
				</div>
			</div>
			<div>
				...
				<div class="d-flex justify-content-center align-items-center gap-100 mar-top-50">
					<input type="button" class="btn btn-dark btn-st fs-2 fw-bold" value="등록" style="width: 150px; height: 60px;" @click="store.rentalInsertData()">
	...
	<script>
		...
		rentalInsertApp.use(createPinia())
		rentalInsertApp.mount('#rental_insert')
	</script>
</body>
</html>